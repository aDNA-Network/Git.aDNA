...
tags: [decision, adr, adr_009, git, dev_process, doctrine, signing, pull_request, coordination, binding, proposed]
---
...
**Status**: `proposed` (genesis **P2**, 2026-06-20; ratified at the P2-exit gate). Binds the "tracking/operations/process for development" mandate (ADR-000 D4). Depends on [[adr_004_provider_contract_interface|ADR-004]], [[adr_005_visibility_host_policy|ADR-005]], [[adr_006_remote_naming|ADR-006]].
