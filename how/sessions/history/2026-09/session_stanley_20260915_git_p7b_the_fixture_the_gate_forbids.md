...
### Where things stand
- **No `proposed` decisions in this vault.** ADR-011 **A8 is ratified**.
...
1. **`census_instrument_meta.sh`** — A8 §7 has bound a non-existent instrument since 2026-09-07, and
   this sitting added three more instruments it would have to classify. `how/backlog/idea_census_instrument_meta.md`.
...
3. **Send the staged Ilmarinen memo** (`coord_2026_09_15_hopper_to_ilmarinen_a8_s6_breadth_ruled`).
4. **R7's fixture** — now the only `⏳ deferred` row; it is a FAIL rule, so it takes 4.4.0's generator.

⛔ **Declined at three consecutive gates and still carried:** the campaign charter's phase table
(`how/campaigns/campaign_git_genesis/campaign_git_genesis.md`), still reading *"P7b obj 4–5
outstanding"* with no mention of the hook/gate arc. ⚠ **Also owed:** the intake-log backfill for the
29th–31st sittings, disclosed in the log rather than skipped.
